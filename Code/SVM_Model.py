...
# test = "điểm chuẩn khoa học máy tính"
...
# # score_test = []
# for i in range(0, 10):
#     X_train, X_test, y_train, y_test = train_test_split(train_x, y, test_size=1/3, random_state=100+i)
#     print("Độ chính xác của giải thuật SVM lần lặp thứ", i+1, "là:", accuracy_score(y_test, clf.predict(X_test)))
